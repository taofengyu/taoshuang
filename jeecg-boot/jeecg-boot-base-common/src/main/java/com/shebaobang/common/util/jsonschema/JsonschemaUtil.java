package com.shebaobang.common.util.jsonschema;
...
public class JsonschemaUtil {
	...
	public static JSONObject getJsonSchema(JsonSchemaDescrip descrip, List<CommonProperty> propertyList) {
		...
		//鬼知道这里为什么报错 com.shebaobang.modules.system.model.DictModel cannot be cast to com.shebaobang.modules.system.model.DictModel
